                ...
                <v-col>
                    <div>
                        ...
                        <v-checkbox v-model="form.personal_type"
                            ...
                            value="เคยเป็นผู้ประกันตนตามมาตรา 33 แห่งพระราชบัญญัติประกันสังคม" hide-details
                            readonly></v-checkbox>
                        <v-checkbox v-model="form.personal_type" label="เป็นสมาชิกธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร"
                            value="เป็นสมาชิกธนาคารเพื่อการเกษตรและสหกรณ์การเกษตร" hide-details readonly></v-checkbox>
...
เงินอื่นๆ ในลักษณะเดียวกัน" hide-details readonly></v-checkbox>
                        <v-checkbox v-model="form.personal_type" label="เป็นผู้พิการ" value="เป็นผู้พิการ" hide-details
                            readonly></v-checkbox>
                        <v-checkbox v-model="form.personal_type" label="ได้รับผลกระทบจากสถานการณ์ความไม่สงบชายแดนภาคใต้"
                            value="ได้รับผลกระทบจากสถานการณ์ความไม่สงบชายแดนภาคใต้" hide-details readonly></v-checkbox>
                        <v-checkbox v-model="form.personal_type"
                            label="เป็นผู้ติดเชื้อ HIV (โรคเอดส์) ที่ไม่มีผู้อุปการะเลี้ยงดู"
                            value="เป็นผู้ติดเชื้อ HIV (โรคเอดส์) ที่ไม่มีผู้อุปการะเลี้ยงดู" hide-details
                            readonly></v-checkbox>
                        <v-row align="center">
                            <v-col cols="3">
                ...
                <div class="text-center mt-7">
                    <v-btn color="primary" class="next-btn" width="283" @click="editPersonal">แก้ไขข้อมูล</v-btn>
                </div>
            </v-form>
        </v-col>
    </v-container>
...
export default {
    ...
    methods: {
        ...
        editPersonal() {
            this.$router.push('/menu/personal/editPersonal')
        }
    }
};
</script>